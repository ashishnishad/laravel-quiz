@extends('layouts.admin.app-login', ['class' => 'login-page', 'page' => __('Admin Login Page'), 'contentClass' => 'login-page'])
...
@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Welcome to Quiz Sytem Admin Panel</h3>
    </div>
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('admin.login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark mb-2">Sign in to <strong>Dashboard</strong></p>
